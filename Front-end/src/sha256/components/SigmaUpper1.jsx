      ...
      <div className="flex">
        ...
        {base === "hex" && (
          <div>
            ...
            <div>{displayHex(rotate6)}</div>
            <div>{displayHex(rotate11)}</div>
            <div className="border-b">{displayHex(rotate25)}</div>
        ...
        {base === "bin" && (
          <div className="mr-3">
            ...
            <div>{decimalToBinary(rotate6).padStart(32, "0")}</div>
            <div>{decimalToBinary(rotate11).padStart(32, "0")} XOR</div>
