...
function UpdateLetters({
  ...
  let kIndex = clock - 51;
  let temp1 =
    (h + sigmaUpper1 + choice + k[kIndex + 1] + w[kIndex + 1]) % 2 ** 32;
  ...
  return (
    <div className="mb-3">
      ...
      <h2 className="font-bold my-1 text-indigo-200">
        {(execute && <div>Update hash values</div>) || (
          <div>Update working variables</div>
        )}
      </h2>
      <div className="flex">
        <div className="flex">
          <div className="mr-3 w-8">
            ...
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h0 </div>
                <div>h0 = </div>
              </div>
            )}
            <div>b =</div>
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h1 </div>
                <div>h1 = </div>
              </div>
            )}
            <div>c =</div>
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h2 </div>
                <div>h2 = </div>
              </div>
            )}
            <div>d =</div>
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h3 </div>
                <div>h3 = </div>
              </div>
            )}
            <div>e =</div>
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h4 </div>
                <div>h4 = </div>
              </div>
            )}
            <div>f =</div>
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h5 </div>
                <div>h5 = </div>
              </div>
            )}
            <div>g =</div>
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h6 </div>
                <div>h6 = </div>
              </div>
            )}
            <div>h =</div>
            {execute && (
              <div className="mb-1">
                <div className="border-b border-transparent">h7 </div>
                <div>h7 = </div>
              </div>
            )}
          </div>
          <div className="mr-3">
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[0]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[0]).padStart(32, "0")}
                </div>
              </div>
            )}
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[1]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[1]).padStart(32, "0")}
                </div>
              </div>
            )}
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[2]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[2]).padStart(32, "0")}
                </div>
              </div>
            )}
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[3]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[3]).padStart(32, "0")}
                </div>
              </div>
            )}
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[4]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[4]).padStart(32, "0")}
                </div>
              </div>
            )}
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[5]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[5]).padStart(32, "0")}
                </div>
              </div>
            )}
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[6]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[6]).padStart(32, "0")}
                </div>
              </div>
            )}
            ...
            {execute && (
              <div>
                <div className="border-b">
                  {decimalToBinary(hsBefore[7]).padStart(32, "0")}
                </div>
                <div className="mb-1">
                  {decimalToBinary(hs[7]).padStart(32, "0")}
                </div>
              </div>
            )}
          </div>
          <div className="mr-3 w-">
            ...
            {execute && (
              <div className="mb-1">
                ...
                <div>
                  ─►{" "}
                  <span className="text-white border px-1 rounded">
                    {displayHex(hs[0])}
                  </span>
                </div>
              </div>
