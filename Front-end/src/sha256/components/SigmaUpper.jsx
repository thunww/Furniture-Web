      ...
      <div className="flex">
        ...
        {base === "bin" && (
          <div className="mr-3">
            ...
            <div
              style={{
                background: `linear-gradient(to right, #ffffff00 0 ${rotations[0]}ch, ${backgroundColor} ${rotations[0]}ch 32ch, #ffffff00 32ch)`,
              }}
            >
            ...
            <div
              style={{
                background: `linear-gradient(to right, #ffffff00 0 ${rotations[1]}ch, ${backgroundColor} ${rotations[1]}ch 32ch, #ffffff00 32ch)`,
              }}
            >
            ...
            <div
              style={{
                background: `linear-gradient(to right, #ffffff00 0 ${rotations[2]}ch, ${backgroundColor} ${rotations[2]}ch 32ch, #ffffff00 32ch)`,
              }}
              className="border-b"
            >
              {decimalToBinary(rotate3).padStart(32, "0")} XOR
            </div>
            <div className="mt-1">{decimalToBinary(xor).padStart(32, "0")}</div>
          </div>
        )}
      </div>
    </div>
