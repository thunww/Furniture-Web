...
function WordResult({ w, firstLoop, base }) {
  ...
  return (
    <div className="mt-6">
      {base === "hex" && (
        <div>
          <div className="border-b">{displayHex(w16)}</div>
          <div>{displayHex(s0)}</div>
          <div>{displayHex(w7)}</div>
          <div className="border-b">{displayHex(s1)}</div>
          <div>{displayHex(sum)}</div>
        </div>
      )}
      ...
      {base === "bin" && (
        <div className="flex">
          <div className="mr-3 w-32">
            ...
            <div className="border-b border-transparent mb-1">σ1</div>
          ...
          <div className="mr-3">
            ...
            <div>{decimalToBinary(s0).padStart(32, "0")} +</div>
