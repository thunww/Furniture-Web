  ...
  return (
    <div className="mb-3">
      <div className="flex">
        ...
        {base === "hex" && (
          <div>
            <div>{displayHex(h)}</div>
            <div>{displayHex(sigmaUpper1)}</div>
            <div>{displayHex(choice)}</div>
            <div className="text-red-500">{displayHex(k[kIndex] >>> 0)}</div>
            <div className="text-yellow-500">{displayHex(w[kIndex])}</div>
            <div>{displayHex(temp1)}</div>
          </div>
        )}
        {base === "bin" && (
          <div className="mr-3">
            ...
            <div>{decimalToBinary(sigmaUpper1).padStart(32, "0")} +</div>
            <div>{decimalToBinary(choice).padStart(32, "0")} +</div>
