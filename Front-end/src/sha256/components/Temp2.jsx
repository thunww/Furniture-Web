  ...
  return (
    <div className="mb-3">
      <div className="flex">
        ...
        {base === "hex" && (
          <div>
            <div>{displayHex(maj)}</div>
            <div>{displayHex(sigmaUpper0)}</div>
            <div>{displayHex(temp2)}</div>
          </div>
        )}
        {base === "bin" && (
          <div className="mr-3">
            <div>{decimalToBinary(maj).padStart(32, "0")} +</div>
            <div>{decimalToBinary(sigmaUpper0).padStart(32, "0")} +</div>
